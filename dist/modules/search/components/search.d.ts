...
export declare class SuiSearch<T> implements AfterViewInit {
    ...
    static ɵfac: i0.ɵɵFactoryDef<SuiSearch<any>>;
    static ɵcmp: i0.ɵɵComponentDefWithMeta<SuiSearch<any>, "sui-search", never, { "hasIcon": "hasIcon"; "placeholder": "placeholder"; "options": "options"; "optionsFilter": "optionsFilter"; "optionsLookup": "optionsLookup"; "optionsField": "optionsField"; "resultFormatter": "resultFormatter"; "resultTemplate": "resultTemplate"; "retainSelectedResult": "retainSelectedResult"; "searchDelay": "searchDelay"; "maxResults": "maxResults"; "transition": "transition"; "transitionDuration": "transitionDuration"; }, { "onResultSelected": "resultSelected"; }, never>;
}
