...
export declare class SuiSidebar {
    ...
    close(): void;
    toggle(): void;
    static ɵfac: i0.ɵɵFactoryDef<SuiSidebar>;
    static ɵcmp: i0.ɵɵComponentDefWithMeta<SuiSidebar, "sui-sidebar", never, { "transition": "transition"; "direction": "direction"; "isVisible": "isVisible"; }, { "isVisibleChange": "isVisibleChange"; }, never>;
}
