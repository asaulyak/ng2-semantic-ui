...
var SuiMultiSelect = /** @class */ (function (_super) {
    ...
    SuiMultiSelect.ɵcmp = i0.ɵɵdefineComponent({ type: SuiMultiSelect, selectors: [["sui-multi-select"]], hostVars: 2, hostBindings: function SuiMultiSelect_HostBindings(rf, ctx) { if (rf & 2) {
...
var SuiMultiSelectValueAccessor = /** @class */ (function (_super) {
    ...
    SuiMultiSelectValueAccessor.ɵdir = i0.ɵɵdefineDirective({ type: SuiMultiSelectValueAccessor, selectors: [["sui-multi-select"]], hostBindings: function SuiMultiSelectValueAccessor_HostBindings(rf, ctx) { if (rf & 1) {
