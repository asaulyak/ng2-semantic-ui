...
import { CommonModule, NgIf, NgForOf, ɵNgClassR2Impl, NgComponentOutlet, NgTemplateOutlet, ɵNgStyleR2Impl, NgSwitch, NgSwitchCase, NgSwitchDefault, NgPlural, NgPluralCase, AsyncPipe, UpperCasePipe, LowerCasePipe, JsonPipe, SlicePipe, DecimalPipe, PercentPipe, TitleCasePipe, CurrencyPipe, DatePipe, I18nPluralPipe, I18nSelectPipe, KeyValuePipe } from '@angular/common';
...
SuiTransition.ɵdir = ɵɵdefineDirective({ type: SuiTransition, selectors: [["", "suiTransition", ""]], hostVars: 6, hostBindings: function SuiTransition_HostBindings(rf, ctx, elIndex) { if (rf & 2) {
...
SuiPagination.ɵcmp = ɵɵdefineComponent({ type: SuiPagination, selectors: [["sui-pagination"]], hostVars: 6, hostBindings: function SuiPagination_HostBindings(rf, ctx, elIndex) { if (rf & 2) {
...
SuiCollapse.ɵdir = ɵɵdefineDirective({ type: SuiCollapse, selectors: [["", "suiCollapse", ""]], hostVars: 6, hostBindings: function SuiCollapse_HostBindings(rf, ctx, elIndex) { if (rf & 2) {
...
SuiCheckboxValueAccessor.ɵdir = ɵɵdefineDirective({ type: SuiCheckboxValueAccessor, selectors: [["sui-checkbox"]], hostBindings: function SuiCheckboxValueAccessor_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
...
SuiRadioValueAccessor.ɵdir = ɵɵdefineDirective({ type: SuiRadioValueAccessor, selectors: [["sui-radio-button"]], hostBindings: function SuiRadioValueAccessor_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
...
SuiCalendarItem.ɵdir = ɵɵdefineDirective({ type: SuiCalendarItem, selectors: [["", "calendarItem", ""]], hostVars: 8, hostBindings: function SuiCalendarItem_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
...
SuiDatepicker.ɵcmp = ɵɵdefineComponent({ type: SuiDatepicker, selectors: [["sui-datepicker"]], hostVars: 6, hostBindings: function SuiDatepicker_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
...
SuiPopupArrow.ɵcmp = ɵɵdefineComponent({ type: SuiPopupArrow, selectors: [["sui-popup-arrow"]], hostVars: 2, hostBindings: function SuiPopupArrow_HostBindings(rf, ctx, elIndex) { if (rf & 2) {
...
SuiPopupController.ɵdir = ɵɵdefineDirective({ type: SuiPopupController, hostBindings: function SuiPopupController_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
...
SuiDatepickerDirective.ɵdir = ɵɵdefineDirective({ type: SuiDatepickerDirective, selectors: [["", "suiDatepicker", ""]], hostBindings: function SuiDatepickerDirective_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
...
SuiDatepickerDirectiveValueAccessor.ɵdir = ɵɵdefineDirective({ type: SuiDatepickerDirectiveValueAccessor, selectors: [["", "suiDatepicker", ""]], hostBindings: function SuiDatepickerDirectiveValueAccessor_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
...
SuiDatepickerDirectiveValidator.ɵdir = ɵɵdefineDirective({ type: SuiDatepickerDirectiveValidator, selectors: [["", "suiDatepicker", ""]], hostBindings: function SuiDatepickerDirectiveValidator_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
...
SuiDatepickerInputDirective.ɵdir = ɵɵdefineDirective({ type: SuiDatepickerInputDirective, selectors: [["input", "suiDatepicker", ""]], hostVars: 3, hostBindings: function SuiDatepickerInputDirective_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
...
SuiDimmer.ɵcmp = ɵɵdefineComponent({ type: SuiDimmer, selectors: [["sui-dimmer"]], hostVars: 6, hostBindings: function SuiDimmer_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
...
SuiModalDimmer.ɵcmp = ɵɵdefineComponent({ type: SuiModalDimmer, selectors: [["sui-modal-dimmer"]], hostVars: 4, hostBindings: function SuiModalDimmer_HostBindings(rf, ctx, elIndex) { if (rf & 2) {
...
SuiModal.ɵcmp = ɵɵdefineComponent({ type: SuiModal, selectors: [["sui-modal"]], viewQuery: function SuiModal_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [SuiModalDimmer, ɵNgClassR2Impl, SuiTransition, NgIf], styles: [""] });
...
SuiProgress.ɵcmp = ɵɵdefineComponent({ type: SuiProgress, selectors: [["sui-progress"]], hostVars: 7, hostBindings: function SuiProgress_HostBindings(rf, ctx, elIndex) { if (rf & 2) {
...
SuiRating.ɵcmp = ɵɵdefineComponent({ type: SuiRating, selectors: [["sui-rating"]], hostVars: 6, hostBindings: function SuiRating_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
...
SuiRatingValueAccessor.ɵdir = ɵɵdefineDirective({ type: SuiRatingValueAccessor, selectors: [["sui-rating"]], hostBindings: function SuiRatingValueAccessor_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
...
SuiSelectSearch.ɵdir = ɵɵdefineDirective({ type: SuiSelectSearch, selectors: [["input", "suiSelectSearch", ""]], hostVars: 3, hostBindings: function SuiSelectSearch_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
...
SuiMultiSelect.ɵcmp = ɵɵdefineComponent({ type: SuiMultiSelect, selectors: [["sui-multi-select"]], hostVars: 2, hostBindings: function SuiMultiSelect_HostBindings(rf, ctx, elIndex) { if (rf & 2) {
...
SuiMultiSelectValueAccessor.ɵdir = ɵɵdefineDirective({ type: SuiMultiSelectValueAccessor, selectors: [["sui-multi-select"]], hostBindings: function SuiMultiSelectValueAccessor_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
...
SuiSelectValueAccessor.ɵdir = ɵɵdefineDirective({ type: SuiSelectValueAccessor, selectors: [["sui-select"]], hostBindings: function SuiSelectValueAccessor_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
...
SuiSidebar.ɵcmp = ɵɵdefineComponent({ type: SuiSidebar, selectors: [["sui-sidebar"]], hostVars: 10, hostBindings: function SuiSidebar_HostBindings(rf, ctx, elIndex) { if (rf & 2) {
...
SuiSidebarSibling.ɵcmp = ɵɵdefineComponent({ type: SuiSidebarSibling, selectors: [["sui-sidebar-sibling"]], hostVars: 6, hostBindings: function SuiSidebarSibling_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
...
SuiTabHeader.ɵdir = ɵɵdefineDirective({ type: SuiTabHeader, selectors: [["", "suiTabHeader", ""]], hostVars: 6, hostBindings: function SuiTabHeader_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
...
SuiTabContent.ɵdir = ɵɵdefineDirective({ type: SuiTabContent, selectors: [["", "suiTabContent", ""]], hostVars: 4, hostBindings: function SuiTabContent_HostBindings(rf, ctx, elIndex) { if (rf & 2) {
